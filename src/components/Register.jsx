    ...
    const handleSubmit = async (event) =>{
        ...
        try {
            ...
            if(res.status === 400 || !res){
                window.alert("Already Used Details Please Login");
            }else{
                ...
                <div className="row">
                    <div className="col-md-5 d-flex flex-column align-items-center  text-white justify-content-center form order-2">
                        <h1 className="display-4 fw-bolder">
                           Welcome To <br/>MJ Tutorials
                        </h1>
                        <p className="lead tex-center">Enter Your Details To Register</p>
                        <h5 className="mb-4">OR</h5>
                        <NavLink to="/login" className="btn btn-outline-light rounded-pill pb-2 w-50">Login</NavLink>
                    </div>
                    <div className="col-md-6 p-5">
                        <h1 className="display-6 fw-border mb-5">Register</h1>
